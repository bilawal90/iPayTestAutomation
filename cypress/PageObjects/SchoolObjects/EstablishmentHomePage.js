class EstablishmentHomePage 
{
  ...
  HEADING_SCHOOL_ADMIN = "//h3[normalize-space()='Establishment Admin Home']"
  ...
  closePopupWindow()
  {
    //cy.xpath(this.POPUP_CLOSE).click();
  //cy.xpath(this.POPUP_CLOSE).click();
  //cy.xpath(this.POPUP_CLOSE).trigger('mouseover').click();
...
clickConfigureLink() {
  ...
  verifySAHeadingAndURL() {
    cy.xpath(this.HEADING_SCHOOL_ADMIN).should("have.text", "Establishment Admin Home");
  ...
  VerifyLinksMenuSA()
  {
    cy.xpath(this.linksMenu).should('have.length','12') ;
  }
  VerifyLinksMenuSF()
  {
...
export default EstablishmentHomePage
