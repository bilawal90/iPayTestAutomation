class KitchenPreOrderReportingPage {
...
HEADING_CUSTOMISE = "#customiseModalLabel"
BTN_CLOSE = "//button[normalize-space()='Close']"
LINK_MEAL_CHOICE = "//a[normalize-space()='Account Meal Choice']"
clickMealChoiceLink()
{
  cy.xpath(this.LINK_MEAL_CHOICE).click()
}
clickCustomiseCloseButton()
{
  cy.wait(1000)
  cy.xpath(this.BTN_CLOSE).trigger('mouseover').click({force: true})
}
verifyCustomiseHeading()
{
    cy.get(this.HEADING_CUSTOMISE)
      .should("be.visible")
      .contains("Customise");
}
...
export default KitchenPreOrderReportingPage
