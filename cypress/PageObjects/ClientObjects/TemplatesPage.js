class TemplatesPage
{
  Heading_Page = "//h3[normalize-space()='Templates']";
  Heading_Temp_Modal = "#ui-id-1"
  DEFAULT_TEMP_Heading_Page = "//h3[normalize-space()='Default Templates']";
  Page_URL = "https://test.ipayimpact.co.uk/Test/Templates/IndexClient"
  ...
  BTN_DEAFULT_SAVE = "//input[@name='btnSubmit']"
  ...
  {
    cy.url().should("eq", this.DEFAULT_TEMP_Page_URL);
  ...
  {
    cy.xpath(this.BTN_DEAFULT_SAVE).should('be.visible');
    cy.xpath(this.BTN_DEAFULT_SAVE).click();
  }
