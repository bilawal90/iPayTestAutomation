class SchoolAddAmountPage
{
  Heading_Page = "//h3[contains(text(),'School Account - Add Banked Amount')]";
  Page_URL = "https://test.ipayimpact.co.uk/Test/Banking/AddBankedDetail?bankDetailID=1082";
  ...
  verifyHeadingandURL()
  {
    ...
    cy.xpath(this.Heading_Page).should('be.visible').and('contain', 'School Account - Add Banked Amount')
  }
  clickSaveAmount()
  {
...
export default SchoolAddAmountPage
