class ClientAddCardPage
{
  Heading_Page = "//h3[contains(text(),'Council Test acount - Add Credit/Debit')]";
  Page_URL = "https://test.ipayimpact.co.uk/Test/Banking/AddCreditDebit?bankDetailID=1081";
...
Validation_Description = "#Description-error";
  verifyHeadingandURL()
  {
    ...
    cy.xpath(this.Heading_Page).should('be.visible').and('contain', 'Council Test acount - Add Credit/Debit')
  }
  clickSaveCard()
  {
...
export default ClientAddCardPage