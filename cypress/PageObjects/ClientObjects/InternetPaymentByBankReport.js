class InternetPaymentByBankReport {
  ...
  URL_PAGE_CLIENT = "https://test.ipayimpact.co.uk/Test/Report/PaymentsByBankAccount"
  URL_REPORT = "https://test.ipayimpact.co.uk/Test/Reports/PaymentsByBank"
...
verifyClientPageHeadingAndURL()
{
    cy.url().should("include", this.URL_PAGE_CLIENT);
    cy.xpath(this.HEADING_PAGE)
      .should("be.visible")
      .contains("Internet Payments By Bank Account");
}
