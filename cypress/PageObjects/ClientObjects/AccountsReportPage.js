class AccountsReportPage {
  ...
  Login_Activity_Page_URL =
    "https://test.ipayimpact.co.uk/Test/Reports/LoginActivity?Parameters=-1%257c444";
  ...
  URL_UNUSED_LOGINS_PAGE =
    "https://test.ipayimpact.co.uk/Test/Report/UnusedLogins?ClientID=444&SchoolID=-1";
  URL_UNUSED_LOGINS_REPORT =
    "https://test.ipayimpact.co.uk/Test/Reports/UnusedLogins?Parameters=-1%257c444%257c3";
  ...
  verifyHeadingAndURL() {
    cy.url().should("eq", this.Login_Activity_Page_URL);
