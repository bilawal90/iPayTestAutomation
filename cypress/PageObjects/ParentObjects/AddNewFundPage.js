class AddNewFundPage {
  ...
  DROPDOWN_CATEGORY_TYPE = "#SchoolFundCategoryID"
...
selectFundCategoryValues() {
  cy.get(this.DROPDOWN_CATEGORY_TYPE).select('Activity').should('have.value', '2')
  cy.get(this.DROPDOWN_CATEGORY_TYPE).select('Club').should('have.value', '3')
  cy.get(this.DROPDOWN_CATEGORY_TYPE).select('Event').should('have.value', '4')
  cy.get(this.DROPDOWN_CATEGORY_TYPE).select('Fees').should('have.value', '8')
  cy.get(this.DROPDOWN_CATEGORY_TYPE).select('Meals').should('have.value', '5')
  cy.get(this.DROPDOWN_CATEGORY_TYPE).select('Milk').should('have.value', '7')
  cy.get(this.DROPDOWN_CATEGORY_TYPE).select('Miscellaneous').should('have.value', '9')
  cy.get(this.DROPDOWN_CATEGORY_TYPE).select('Shop').should('have.value', '6')
  cy.get(this.DROPDOWN_CATEGORY_TYPE).select('Trip').should('have.value', '1')
}
}
