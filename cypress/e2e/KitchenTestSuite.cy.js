...
import Login from "../PageObjects/KitchenObjects/LoginPage"
...
import MealRecordingPage from "../PageObjects/KitchenObjects/MealRecordingPage.js"
...
import FundNotificationsPage from "../PageObjects/KitchenObjects/FundNotificationsPage.js"
...
import AccountsReportPage from "../PageObjects/KitchenObjects/AccountsReportPage.js"
...
import MealRecordingByWeekReport from "../PageObjects/KitchenObjects/MealRecordingByWeekReport.js"
import MealRecordingUnAttendedReport from "../PageObjects/KitchenObjects/MealRecordingUnAttendedReport.js"
...
describe("KitchenTestSuite", () => {
  ...
  it("Positive Login Testcase", () => {
    cy.fixture("TestData").then((data) => {
      ln.setUserName(data.KitchenUsername)
      ln.setPassword(data.KitchenPassword)
      ln.clickLogon()
  ...
  it("Verify Meal Recording Page from the Menu Links", () => {
    ln2.clickLinkRecording()
    ln4 = new MealRecordingPage
    ln4.verifyPageHeadingAndURL()
    ln4.clickSelectButton()
    ln4.verifyMealValidationAppearing()
    ln4.selectWeek();
    ln4.selectYear();
    ln4.clickSelectButton()
    ln4.verifyPageHeadingAndURLOnMealRecording();
    ln4.clickSaveButton();
    ln4.verifySuccessMessage()
  })
  ...
  it("Verify Notifications Link on the Pre Order School Meal Fund", () => {
    ln6.clickNotificationsLink();
    ln11 = new FundNotificationsPage
    ln11.verifyPageHeadingAndURL()
    ln11.verifyStep1Heading()
    ln11.verifyAccountsInfo();
    ln11.clickSentNotificationsLink();
    ln11.verifySentNotificationInfoText();
    ln11.clickAutoNotificationsLink()
    ln11.verifyBalanceAlertText()
    ln11.clickReturnToFundButton();
    ln6.verifyPageHeadingAndURL();
  })
  ...
  it("Verify Login Activity Report", () => {
    ln21.clickLoginActivityLink();
    ln22 = new AccountsReportPage
    ln22.verifyHeadingAndURL();
    ln22.clickReportReturnButton();
    ln21.verifyHeadingsAndURLOnReturn();
  });
  it("Verify Unused Logins Report", () => {
    ln21.clickUnusedLoginsLink();
    ln22.verifyHeadersOnUnusedLoginPage();
    ln22.clickRunReportButton();
    ln22.verifyHeadersOnUnusedLoginReport();
    ln22.clickReportReturnButton();
    ln21.verifyHeadingsAndURLOnReturn();
  });
  ...
  it("Verify Meal Recording By Day Report Page", () => {
    ln21.clickMealRecordingByDayLink()
    ln4.verifyPageHeadingAndURLByDay();
    ln4.clickRunReportButton();
    ln4.verifyReportHeadingAndURLByDay();
    ln4.clickReportBackButton();
  })
  it("Verify Meal Recording By Week Report", () => {
    ln21.clickMealRecordingByWeekLink();
    ln30 = new MealRecordingByWeekReport();
    ln30.verifyPageHeadingAndURL();
    ln30.clickRunReport();
    ln30.verifyReportHeadingAndURL();
    ln30.clickReportBackButton();
    ln21.verifyHeadingsAndURLOnReturn();
  });
  it("Verify Meal Recording - Unattended Report", () => {
    ln21.clickMealRecordingUnattendedLink();
    ln31 = new MealRecordingUnAttendedReport();
    ln31.verifyPageHeadingAndURL();
    ln31.clickRunReport();
    ln31.verifyReportHeadingAndURL();
    ln31.clickReportBackButton();
    ln21.verifyHeadingsAndURLOnReturn();
  });
